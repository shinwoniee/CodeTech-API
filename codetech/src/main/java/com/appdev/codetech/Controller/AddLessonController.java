...
import com.appdev.codetech.Service.AddLessonService;
...
public class AddLessonController {
    ...
    public ResponseEntity<AddLessonEntity> updateLesson(@PathVariable int lid,
            @RequestBody AddLessonEntity updatedLesson) {
