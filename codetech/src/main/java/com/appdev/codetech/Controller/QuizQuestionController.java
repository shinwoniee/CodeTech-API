...
import com.appdev.codetech.Service.QuizQuestionService;
...
public class QuizQuestionController {
    ...
    public ResponseEntity<QuizQuestionEntity> updateQuestion(@PathVariable int qid,
            @RequestBody QuizQuestionEntity updatedQuestion) {
